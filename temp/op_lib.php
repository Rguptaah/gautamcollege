...
function rtfmail($to, $subject, $msg, $post_arr)
{
    extract($post_arr);
    global $inst_logo;
    global $inst_name;
    ...
    if (isset($name) and isset($phone)) {
        $message .= "<tr><td colspan='5' aling='center' valign='top' height='350px' style='font-size:18px;'>
    	<p>Customer Name : $name <br> Contact Number: $phone </p> <p> $msg </p></td></tr>";
    } else {
        $message .= "<tr><td colspan='5' aling='center' valign='top' height='350px' style='font-size:18px;'>
	    <p style='font-size:18px;'> $msg </p></td></tr>";
    }
    $message .= "<tr><td colspan='5' style='background:rgb(229, 24, 55)' align='left'>Regards, <br> $inst_name <br> $inst_address1, $inst_address2 <br> <strong style='color:black;font-weight:bold;'> $inst_email  | $inst_url </strong> </td></tr>";
    $message .= '</table>';
    $message .= '</body></html>';
